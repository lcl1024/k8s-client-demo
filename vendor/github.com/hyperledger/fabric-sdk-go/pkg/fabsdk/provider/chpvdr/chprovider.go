...
func (cs *ChannelService) Transactor(reqCtx reqContext.Context, orderer fab.Orderer) (fab.Transactor, error) {
	cfg, err := cs.ChannelConfig()
	if err != nil {
		return nil, err
	}
	return channelImpl.NewTransactor(reqCtx, cfg, orderer)
}

...
type MockChannelService struct {
	...
	TransactorStub        func(reqCtx reqContext.Context, orderer fab.Orderer) (fab.Transactor, error)
...
func (fake *MockChannelService) Transactor(reqCtx reqContext.Context, orderer fab.Orderer) (fab.Transactor, error) {
	...
	if fake.TransactorStub != nil {
		return fake.TransactorStub(reqCtx, orderer)
	}
	if specificReturn {
		return ret.result1, ret.result2
	}

...
// NewClient ...
func NewClient(identity string, mspID string, dir string, gm bool, gmLibrary string) (*Client, error) {
...
func initializeMsp(identity string, dir string, mspID string, bccspConfig *factory.FactoryOpts) (msp.MSP, error) {
	...
	mspInst, err := msp.New(&msp.BCCSPNewOpts{msp.NewBaseOpts{Version: msp.MSPv1_4_3}})
	if err != nil {
		return nil, err
	}

...
import (
	...
	x5092 "github.com/hyperledger/fabric/common/x509"
...
var (
	...
	genX509Plugin           = genSignerConfig.Flag("x509", "The x509 plugin to use. Default is standard x509").String()
...
func main() {
	...
	if err := x5092.InitX509(*genX509Plugin); err != nil {
	...
	case genIssuerKey.FullCommand():
		...
		handleError(err)
		encodedRevocationSK, err := x509.MarshalECPrivateKey((*crypto.PrivateKey)(unsafe.Pointer(revocationKey)))
		handleError(err)

...
func TestLoadPrivateKey(t *testing.T) {
	priv, _, err := csp.GeneratePrivateKey(testDir, "SW")
	...
	loadedPriv, _, err := csp.LoadPrivateKey(testDir, "SW")
	assert.NoError(t, err)
...
func TestLoadPrivateKey_wrongEncoding(t *testing.T) {
	...
	_, _, err = csp.LoadPrivateKey(testDir, "SW")
	assert.NotNil(t, err)
...
func TestGeneratePrivateKey(t *testing.T) {
	...
	priv, signer, err := csp.GeneratePrivateKey(testDir, "SW")
